...
public final class PdcKeys {
  ...
  public static final NamespacedKey FIRST_JOIN = new NamespacedKey("orbis", "first_join");
  public static final NamespacedKey PLAYTIME = new NamespacedKey("orbis", "playtime");
